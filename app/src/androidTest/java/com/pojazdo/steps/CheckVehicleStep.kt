...
class CheckVehicleStep : GreenCoffeeSteps() {
    ...
    fun scrollToTimeLine() =
            RecyclerViewActions.scrollTo<RecyclerView.ViewHolder>(
                    ViewMatchers.hasDescendant(ViewMatchers.withText("Dane sprzedającego")))
    ...
    fun isSeeVehicleSummaryHeaderOśCzasu() {
        ...
        onView(ViewMatchers.withText(VehicleSummaryRobot.RATING_HEADER)).perform(click())
