...
import com.mirek.architecture.AndroidTestScheduler
import com.mirek.architecture.ui.Event
import com.mirek.architecture.ui.base.Command
import com.mirek.data.network.vehicledecoder.model.VehicleDecodedInfo
...
/*    @Test
    fun `check vehicle`() {
        ...
        systemUnderTest.checkVehicle(anyString(), anyString(), anyString())
