...
import com.mirek.architecture.ui.platform.BaseFragment
import kotlinx.android.synthetic.main.fragment_inputa_data_form.*
...
class FormFragment : BaseFragment() {
    ...
    override fun layoutId() = R.layout.fragment_inputa_data_form
